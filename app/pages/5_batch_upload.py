...
st.set_page_config(page_title="MedAgent -- Выписка және басқа құжаттар", page_icon="📚")
st.title("📚 Выписка және басқа құжаттар")
...
with st.expander("Құжат түрі қалай анықталады?"):
    st.write(
        ...
        "Ондай файл табылса, оны «Анализ жүктеу» бетінде жүктеп, кестені "
            ...
            results.append(
                {
                    "file": uf.name,
                    "status": "needs_manual",
                    "detail": "Бұл анализ сияқты -- «Анализ жүктеу» бетінде жүктеп растаңыз.",
                }
            )
