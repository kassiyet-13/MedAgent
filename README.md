...
> 🎬 **Демо:** _ссылка на видео — TODO_
> 📐 Архитектура: [ARCHITECTURE.md](ARCHITECTURE.md) · 📊 Evals и A/B: [EVALS.md](EVALS.md)
...
| Загрузка и очередь анализов | Подтверждение значений |
|---|---|
| ![upload](docs/screenshots/01_upload.png) | ![confirm](docs/screenshots/02_confirm.png) |
| **Объяснение KZ / RU** | **История и тренды** |
