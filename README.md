...
> 📐 Архитектура: [ARCHITECTURE.md](ARCHITECTURE.md) · 📊 Evals и A/B: [EVALS.md](EVALS.md) · 🎤 Презентация защиты (PDF): [на русском](MedAgent%20защита.pdf) · [на казахском](MedAgent%20қорғау.pdf)
